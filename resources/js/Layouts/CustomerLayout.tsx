...
export interface CustomerLayoutProps extends React.PropsWithChildren {
    title?: string;
}
export function CustomerLayout({ title, children }: CustomerLayoutProps) {
        ...
        <div className="flex min-h-screen w-full flex-col bg-muted/40">
                    ...
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <Link
                                ...
                                className={`flex h-9 w-9 items-center justify-center rounded-lg ${
                                    route().current("customer.products")
                                        ? activeMenuClass
                                        : "text-muted-foreground"
                                } transition-colors hover:text-foreground md:h-8 md:w-8`}
                            >
            ...
            <div className="flex flex-col sm:gap-4 sm:py-4 sm:pl-14">
                <header className="sticky top-0 z-30 flex h-14 items-center gap-4 border-b bg-background px-4 sm:static sm:h-auto sm:border-0 sm:bg-transparent sm:px-6">
                    ...
                    <ModeToggle />
                    <NotificationSystem notifications={auth.notifications} />
                    <DropdownMenu>
